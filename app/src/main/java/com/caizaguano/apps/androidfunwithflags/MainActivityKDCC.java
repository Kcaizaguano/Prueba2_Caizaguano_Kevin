...
public class MainActivityKDCC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewusario = findViewById(R.id.textViewusuario);
        textViewusario.setText(usuario);
    }
